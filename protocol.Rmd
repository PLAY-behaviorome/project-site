...
<td width="25%"> <img src="img/mic.eps"> </td>
</tr>
<tr>
<td width="25%"> Fully loaded and charged tablet</td>
<td width="25%"> <img src="img/tablet.eps"> </td>
...
<td width="25%" style="padding-right: 40px;"> <img src="img/dm-mic.eps"> </td>
<td width="25%"> Tripod for camera</td>
<td width="25%"> <img src="img/tripod.eps"> </td>
</tr>
<tr>
<td width="25%"> Tote bag  </td>
<td width="25%"> <img src="img/tote.eps"> </td>
<td width="25%"> Yoga mat </td>
<td width="25%" style="padding-right: 40px;"> <img src="img/yoga-mat.eps"> </td>
</tr>
<tr>
